  ...
  return (
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      ...
      <div className="p-5 space-y-5">
            ...
            {tab === 'SELL' && userPosition && userPosition.position_type === position ? (
              <>
                <button
                  ...
                  className="flex-1 py-2 rounded-lg bg-background border border-border text-sm text-muted hover:text-text hover:border-accent transition-colors"
                >
                  25%
                </button>
                <button
        ...
        {success && (
          <div className="p-3 rounded-lg bg-yes/10 border border-yes/20 text-yes text-sm">
            {success}
          </div>
        )}
