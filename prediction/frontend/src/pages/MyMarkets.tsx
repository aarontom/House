  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          to="/create"
          className="flex items-center gap-2 px-4 py-2 brand-gradient hover:brand-glow text-white font-medium rounded-xl transition-all"
        >
            ...
            {selectedMarket ? (
              <div className="space-y-6">
                  ...
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div>
                      <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium mb-2 ${
                        selectedMarket.category === 'custom' ? 'bg-[#F7931E]/10 text-[#F7931E]' :
                    ...
                    {selectedMarket.status === 'open' && (
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F7931E]/10 text-[#F7931E] text-sm font-medium hover:bg-[#F7931E]/20 transition-colors"
                      >
                ...
                {selectedMarket.status === 'open' && (
                  <div className="bg-card border border-border rounded-2xl p-6">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-background border border-border text-text placeholder-muted focus:outline-none focus:border-[#F7931E] min-h-[100px] resize-none"
                      placeholder={
                        updateType === 'media'
                    ...
                    <button
                      ...
                      className="mt-3 flex items-center gap-2 px-4 py-2 brand-gradient hover:brand-glow text-white font-medium rounded-lg transition-all disabled:opacity-50"
                    >
                ...
                <Link
                  ...
                  className="block w-full py-3 text-center bg-background border border-border rounded-xl brand-gradient-text font-medium hover:bg-card transition-colors"
                >
