  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-8 animate-fade-in">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#FF6B35]/10 via-[#F7931E]/10 to-[#FEC84D]/10 text-sm font-medium mb-4 animate-slide-in-up">
          <Sparkles className="h-4 w-4 text-[#F7931E]" />
          <span className="brand-gradient-text font-semibold">Create Anything, Trade Everything</span>
        </div>
        <h1 className="text-4xl md:text-5xl font-bold text-text mb-4 animate-slide-in-up" style={{ animationDelay: '100ms' }}>
          Welcome to <span className="brand-gradient-text">House</span>
        </h1>
        <p className="text-lg text-muted max-w-2xl mx-auto mb-6 animate-slide-in-up" style={{ animationDelay: '200ms' }}>
          Create your own prediction markets for everyday events. Any event, any time. Be the House. 
        </p>
        <Link
          to="/create"
          className="inline-flex items-center gap-2 px-6 py-3 brand-gradient hover:brand-glow text-white font-semibold rounded-xl transition-all duration-200 hover:scale-105 active:scale-95"
        >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                  statusFilter === filter.value
                    ...
                    : 'bg-card text-muted hover:text-text hover:bg-card-hover hover:scale-105 active:scale-95'
                }`}
              >
