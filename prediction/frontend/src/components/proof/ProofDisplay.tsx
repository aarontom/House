  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <h3 className="text-lg font-semibold text-text mb-3">{resolution.market_title}</h3>
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-text">Resolution Criteria</h3>
        </div>
        <div className="bg-background rounded-xl p-4 font-mono text-sm">
          <div className="grid grid-cols-3 gap-4">
            <div>
              <span className="text-muted block mb-1">Path</span>
              <span className="text-text">{resolution.resolution_criteria.path}</span>
            </div>
            <div>
              <span className="text-muted block mb-1">Operator</span>
              <span className="text-text">{resolution.resolution_criteria.operator}</span>
            </div>
            <div>
              <span className="text-muted block mb-1">Expected</span>
              <span className="text-text">{String(resolution.resolution_criteria.value)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-text">Data Source</h3>
        </div>
        ...
        <div className="bg-background rounded-xl p-4">
          ...
          <pre className="text-sm text-text overflow-x-auto max-h-48 font-mono">
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-text">Resolution Steps</h3>
        </div>
        ...
        <div className="space-y-4">
          {resolution.calculation_steps.map((step, index) => (
            ...
            >
              ...
              {/* Step content */}
              <div className="bg-background rounded-xl p-4">
                <p className="text-text font-medium mb-2">{step.description}</p>
                {step.input && (
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-text">Final Determination</h3>
        </div>
        ...
        <div className="flex items-center justify-between bg-background rounded-xl p-4">
          <div>
            ...
            <span className="text-text text-xl font-bold font-mono">{resolution.final_value}</span>
          </div>
